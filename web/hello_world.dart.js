...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    FlartMaterialColor: function FlartMaterialColor(t0) {
      this.hex = t0;
    },
    ...
    ElevatedButton: function ElevatedButton(t0, t1) {
      this.child = t0;
      this.onPressed = t1;
    },
    ...
    main() {
      var t1, t2;
      $._rootWidget = new A.HelloFlartApp();
      t1 = document;
    ...
    HelloFlartApp: function HelloFlartApp() {
    },
    HelloFlartApp_build_closure: function HelloFlartApp_build_closure() {
    },
    isBrowserObject(o) {
    ...
    _renderApp() {
      var context, html, e, t2, exception,
        t1 = $._rootWidget;
      ...
      try {
        ...
        t2 = type$.BuildContext._as(context);
        html = t1.build$1(t2).render$1(t2);
        t2 = $._appContainer;
        t2.toString;
        J.setInnerHtml$2$treeSanitizer$x(t2, html, B.C__TrustedHtmlTreeSanitizer);
  ...
  A.Center.prototype = {
    render$1(context) {
      return string$.______ + this.child.render$1(context) + "\n      </div>\n    ";
    }
  };
  A.Column.prototype = {
    render$1(context) {
  ...
  A.Scaffold.prototype = {
    render$1(context) {
      ...
      t2 = this.body.child.render$1(context);
      t1 = t1 + "\n" + ('<div style="flex: 1; overflow: auto;">' + (string$.______ + t2 + "\n      </div>\n    ") + "</div>\n");
  ...
  A.Widget.prototype = {};
  A.HelloFlartApp.prototype = {
    build$1(context) {
      return new A.MaterialApp("Hello Flart", new A.Scaffold(new A.AppBar(new A.Text("Hello Flart!", null), B.FlartMaterialColor_G8r), new A.Center(new A.Column(A._setArrayType([new A.Text("Welcome to Flart! \ud83c\udfa8", new A.TextStyle("#007bff", 32, B.C_FontWeight)), new A.SizedBox(20), new A.Text("A Flutter-inspired UI framework for Dart Web", new A.TextStyle("#666666", 16, null)), new A.SizedBox(40), new A.ElevatedButton(new A.Text("Click Me", null), new A.HelloFlartApp_build_closure())], type$.JSArray_Widget), B.MainAxisAlignment_1))));
    }
  };
  A.HelloFlartApp_build_closure.prototype = {
    call$0() {
      return A.print("Button clicked!");
    },
    $signature: 18
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static(A, "html__Html5NodeValidator__standardAttributeValidator$closure", 4, null, ["call$4"], ["_Html5NodeValidator__standardAttributeValidator"], 4, 0);
    _static(A, "html__Html5NodeValidator__uriAttributeValidator$closure", 4, null, ["call$4"], ["_Html5NodeValidator__uriAttributeValidator"], 4, 0);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure, [A.Closure2Args, A.Closure0Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A.Element_Element$html_closure, A.NodeValidatorBuilder_allowsElement_closure, A.NodeValidatorBuilder_allowsAttribute_closure, A._SimpleNodeValidator_closure, A._SimpleNodeValidator_closure0, A._TemplatingNodeValidator_closure, A._convertToJS_closure, A._convertToJS_closure0, A._wrapToDart_closure, A._wrapToDart_closure0, A._wrapToDart_closure1, A.FlartCallbackManager__injectGlobalHandler_closure, A.Column_render_closure, A.Column_render_closure0, A.ElevatedButton_render_closure, A.ElevatedButton_render_closure0, A.ElevatedButton_render_closure1, A.ElevatedButton_render_closure2, A.Scaffold_render_closure, A.SizedBox_render_closure, A.Text_render_closure]);
    _inheritMany(A.Closure2Args, [A.Primitives_functionNoSuchMethod_closure, A.JsLinkedHashMap_addAll_closure, A.initHooks_closure0, A.MapBase_mapToString_closure, A.NoSuchMethodError_toString_closure, A._ValidatingTreeSanitizer_sanitizeTree_walk]);
    ...
    _inheritMany(A.Widget, [A.Center, A.Column, A.ElevatedButton, A.StatelessWidget, A.AppBar, A.MaterialApp, A.Scaffold, A.SizedBox, A.Text]);
    _inherit(A.HelloFlartApp, A.StatelessWidget);
    _inherit(A.HelloFlartApp_build_closure, A.Closure0Args);
...
;
    ...
    B.Map_tFBcW = new A.GeneralConstantMap([50, B.FlartColor_zoP, 100, B.FlartColor_Gn4, 200, B.FlartColor_UZE, 300, B.FlartColor_ISC, 400, B.FlartColor_zTR, 500, B.FlartColor_QOb, 600, B.FlartColor_LG4, 700, B.FlartColor_fnX, 800, B.FlartColor_VUl, 900, B.FlartColor_cez], A.findType("GeneralConstantMap<int,FlartColor>"));
    B.FlartMaterialColor_G8r = new A.FlartMaterialColor("#2196F3");
  ...
  (function staticFields() {
    ...
    $._rootWidget = null;
    $._appContainer = null;
    $.FlartCallbackManager__handlers = A.LinkedHashMap_LinkedHashMap$_empty(type$.String, A.findType("~()"));
